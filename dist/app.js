...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = _react2.default.createClass({
	  ...
	  rawMarkup: function rawMarkup() {
	    var rawMarkup = (0, _marked2.default)(this.state.typed.toString(), { sanitize: true, gfm: true, breaks: true });
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement("textarea", { onChange: this.onChange }),
	...
	_reactDom2.default.render(_react2.default.createElement(Input, { url: "/send" }), document.getElementById('content'));
